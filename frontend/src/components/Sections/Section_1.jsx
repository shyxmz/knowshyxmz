    ...
    <div className='h-[calc(100vh-10rem)] flex [&>*]:flex-1'>
        ...
        >
            <div className='w-96 px-12 py-20 text-white flex flex-col gap-4'>
                ...
                <h1 className='txt text-xl font-bold'>Ipsum Dolor</h1>
                <p className='txt text-sm leading-6 text-gray-200'>Lorem Ipsum dolor sit amet blah blah lorem ipsum dolor sit amet lala
